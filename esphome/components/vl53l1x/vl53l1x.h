...
class VL53L1XComponent : public PollingComponent, public Adafruit_VL53L1X {
 public:
  ...
  void set_distance_sensor(sensor::Sensor *sensor_distance) { sensor_distance_ = sensor_distance; }
  void set_threshold_sensor(sensor::Sensor *sensor_threshold) { sensor_threshold_ = sensor_threshold; }
 ...
 protected:
  ...
  sensor::Sensor *sensor_distance_{nullptr};
  sensor::Sensor *sensor_threshold_{nullptr};
